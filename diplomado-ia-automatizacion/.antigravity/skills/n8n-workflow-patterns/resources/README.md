...
**n8n-mcp tools**:
- mcp_n8n-mcp_search_nodes (find nodes for patterns)
- mcp_n8n-mcp_get_node (understand node operations)
- mcp_n8n-mcp_search_templates (find example workflows)
...
Use `mcp_n8n-mcp_search_templates` to find examples for your use case!
...
4. Find nodes for pattern (mcp_n8n-mcp_search_nodes)
5. Understand node operations (mcp_n8n-mcp_get_node)
