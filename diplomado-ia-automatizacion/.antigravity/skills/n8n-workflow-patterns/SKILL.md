...
1. **[Webhook Processing](resources/webhook_processing.md)** (Most Common)
...
3. **[Database Operations](resources/database_operations.md)**
   - Read/Write/Sync database data
   - Pattern: Schedule → Query → Transform → Write → Verify

4. **[AI Agent Workflow](resources/ai_agent_workflow.md)**
   - AI agents with tools and memory
   - Pattern: Trigger → AI Agent (Model + Tools + Memory) → Output

5. **[Scheduled Tasks](resources/scheduled_tasks.md)**
...
- [ ] List required nodes (use mcp_n8n-mcp_search_nodes)
...
### Validation Phase
- [ ] Validate each node configuration (mcp_n8n-mcp_validate_node)
- [ ] Validate complete workflow (mcp_n8n-mcp_n8n_validate_workflow)
...
- Find nodes for your pattern (mcp_n8n-mcp_search_nodes)
- Understand node operations (mcp_n8n-mcp_get_node)
- Create workflows (mcp_n8n-mcp_n8n_create_workflow)
- Deploy templates (mcp_n8n-mcp_n8n_deploy_template)
...
- **[webhook_processing.md](resources/webhook_processing.md)** - Webhook patterns, data structure, response handling
- **[http_api_integration.md](http_api_integration.md)** - REST APIs, authentication, pagination, retries
- **[database_operations.md](resources/database_operations.md)** - Queries, sync, transactions, batch processing
- **[ai_agent_workflow.md](resources/ai_agent_workflow.md)** - AI agents, tools, memory, langchain nodes
- **[scheduled_tasks.md](resources/scheduled_tasks.md)** - Cron schedules, reports, maintenance tasks
...
Use `mcp_n8n-mcp_search_templates` and `mcp_n8n-mcp_get_template` from n8n-mcp tools to find examples!
