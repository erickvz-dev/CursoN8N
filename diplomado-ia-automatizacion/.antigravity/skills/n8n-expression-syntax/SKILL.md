...
For complete error catalog with fixes, see [COMMON_MISTAKES.md](resources/COMMON_MISTAKES.md)
...
For real workflow examples, see [EXAMPLES.md](resources/EXAMPLES.md)
...
- [COMMON_MISTAKES.md](resources/COMMON_MISTAKES.md) - Complete error catalog
- [EXAMPLES.md](resources/EXAMPLES.md) - Real workflow examples
