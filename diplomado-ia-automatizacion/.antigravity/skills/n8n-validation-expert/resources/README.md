...
const preview = mcp_n8n-mcp_n8n_autofix_workflow({
  id: "workflow-id",
...
- **n8n Validation API**: validate_node_operation, mcp_n8n-mcp_n8n_validate_workflow, mcp_n8n-mcp_n8n_autofix_workflow
