...
**See**: [DATA_ACCESS.md](use `view_file` tool on /Users/rodrigoleanosbermejo/Desktop/flujoRecursosHumanos/.agents/skills/n8n-code-python/resources/DATA_ACCESS.md to read) for comprehensive guide
...
**See**: [DATA_ACCESS.md](use `view_file` tool on /Users/rodrigoleanosbermejo/Desktop/flujoRecursosHumanos/.agents/skills/n8n-code-python/resources/DATA_ACCESS.md to read) for full webhook structure details
...
**See**: [ERROR_PATTERNS.md](use `view_file` tool on /Users/rodrigoleanosbermejo/Desktop/flujoRecursosHumanos/.agents/skills/n8n-code-python/resources/ERROR_PATTERNS.md to read) #2 for detailed error solutions
...
**See**: [STANDARD_LIBRARY.md](use `view_file` tool on /Users/rodrigoleanosbermejo/Desktop/flujoRecursosHumanos/.agents/skills/n8n-code-python/resources/STANDARD_LIBRARY.md to read) for complete reference
...
**See**: [COMMON_PATTERNS.md](use `view_file` tool on /Users/rodrigoleanosbermejo/Desktop/flujoRecursosHumanos/.agents/skills/n8n-code-python/resources/COMMON_PATTERNS.md to read) for 10 detailed Python patterns
...
**See**: [ERROR_PATTERNS.md](use `view_file` tool on /Users/rodrigoleanosbermejo/Desktop/flujoRecursosHumanos/.agents/skills/n8n-code-python/resources/ERROR_PATTERNS.md to read) for comprehensive error guide
...
- How to find Code node: `mcp_n8n-mcp_search_nodes({query: "code"})`
...
### Related Files
- [DATA_ACCESS.md](use `view_file` tool on /Users/rodrigoleanosbermejo/Desktop/flujoRecursosHumanos/.agents/skills/n8n-code-python/resources/DATA_ACCESS.md to read) - Comprehensive Python data access patterns
- [COMMON_PATTERNS.md](use `view_file` tool on /Users/rodrigoleanosbermejo/Desktop/flujoRecursosHumanos/.agents/skills/n8n-code-python/resources/COMMON_PATTERNS.md to read) - 10 Python patterns for n8n
- [ERROR_PATTERNS.md](use `view_file` tool on /Users/rodrigoleanosbermejo/Desktop/flujoRecursosHumanos/.agents/skills/n8n-code-python/resources/ERROR_PATTERNS.md to read) - Top 5 errors and solutions
- [STANDARD_LIBRARY.md](use `view_file` tool on /Users/rodrigoleanosbermejo/Desktop/flujoRecursosHumanos/.agents/skills/n8n-code-python/resources/STANDARD_LIBRARY.md to read) - Complete standard library reference
